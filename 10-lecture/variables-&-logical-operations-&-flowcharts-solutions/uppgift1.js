...
let cars_with_drivers = cars - cars_without_drivers;//Räkna ut hur många bilar som har en förare;
  
let carpool_capacity = seats_in_car * cars_with_drivers;//Räkna ut det totala antalet platser alla bilar med förare har tillsammans;
  
let average_passengers_per_car_in_pool = passengers / cars_with_drivers;//Räkna ut snittet på antal passagerare per bil som ingår i carpoolen.
