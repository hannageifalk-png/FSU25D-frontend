...
## 2. JS loops
- Study the code in [js-loops](js-loops) 
- Exercises [lab1](lab1)
...
- [JS While Loop](https://www.w3schools.com/js/js_loop_while.asp)
- [JS For Loop](https://www.w3schools.com/js/js_loop_for.asp)
- [JS Break and Continue](https://www.w3schools.com/js/js_break.asp)
